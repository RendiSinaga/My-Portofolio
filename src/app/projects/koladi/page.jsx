...
const project = {
  title: "Koladi",
  subtitle: "All-in-One Virtual Workspace Platform",
  ...
  problem:
    "Remote and hybrid teams often face scattered communication, unclear task progress, separated documents, and difficulty monitoring team performance across different workspaces.",
  solution:
    "Koladi provides an integrated workspace where teams can organize projects, manage tasks, communicate, track schedules, store documents, and monitor performance from a single platform.",
};

const contributions = [
  "Developed core web features for workspace, task, document, announcement, and performance report modules.",
  "Implemented role-based workspace access and team management features.",
  "Built task management flows including task status, progress, labels, participants, and deadlines.",
  "Worked with PostgreSQL database structure and Laravel backend logic.",
  "Integrated frontend interfaces using Tailwind CSS and interactive JavaScript behavior.",
];

const features = [
  "Workspace and team management",
  "Task board with progress tracking",
  "Announcement and communication module",
  "Document management",
  "Schedule and calendar feature",
...
const gallery = [
  ...
  },
  {
    ...
    type: "Screenshot",
    image: "/projects/koladi/performance-report.png",
  },
  {
    title: "Task Board",
    type: "Screenshot",
    image: "/projects/koladi/task-board.png",
  },
  {
...
export default function KoladiDetail() {
      ...
      <section className="detail-cta">
        <div className="detail-container">
          ...
          >
            ...
            <h2>Integrated Workspace for Team Collaboration</h2>

            <p>
              This project strengthened my experience in building a multi-module
              web application with workspace management, task tracking,
              communication features, document handling, and performance
              monitoring.
            </p>
